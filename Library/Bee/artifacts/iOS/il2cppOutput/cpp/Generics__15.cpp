...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR ValueCollection_t930CB5B0FA5C49F2E6B424AA8782F5CD52059D7E* Dictionary_2_get_Values_m49FDD892FB446B871ED273F32ED6309FEBF548E4_gshared (Dictionary_2_t9ED881003B3B6D4293A07C01CFE862F953347FF6* __this, const RuntimeMethod* method) 
{
	...
	{
		ValueCollection_t930CB5B0FA5C49F2E6B424AA8782F5CD52059D7E* L_1 = (ValueCollection_t930CB5B0FA5C49F2E6B424AA8782F5CD52059D7E*)il2cpp_codegen_object_new(il2cpp_rgctx_data(method->klass->rgctx_data, 28));
		ValueCollection__ctor_mE483A22A34D50A50265B7378C666D1B71936456B(L_1, __this, il2cpp_rgctx_method(method->klass->rgctx_data, 29));
		__this->____values = L_1;
		Il2CppCodeGenWriteBarrier((void**)(&__this->____values), (void*)L_1);
	}
...
IL_009a:
	{
		...
		NullCheck(L_25);
		int32_t L_27;
		L_27 = KeyValuePair_2_get_Value_m0F7740856752508C011662841E7F06EB56CFD1FF_inline(((L_25)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_26))), il2cpp_rgctx_method(method->klass->rgctx_data, 24));
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Dictionary_2_Remove_m53DF9B8B92EC3C2BD4A200E6DFE5F2F939E6395A_gshared (Dictionary_2_t9ED881003B3B6D4293A07C01CFE862F953347FF6* __this, Il2CppChar ___0_key, int32_t* ___1_value, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	int32_t V_1 = 0;
	int32_t V_2 = 0;
...
IL_00d6:
	{
		...
		*(int32_t*)L_38 = L_40;
		...
		L_41->___hashCode = (-1);
		Entry_t8ED08A480C5A559A00D0C02FFA3804D49FD4622C* L_42 = V_4;
		int32_t L_43 = __this->____freeList;
		L_42->___next = L_43;
		goto IL_010c;
	}
...
IL_0145:
	{
		int32_t L_47 = V_3;
		V_2 = L_47;
		Entry_t8ED08A480C5A559A00D0C02FFA3804D49FD4622C* L_48 = V_4;
		int32_t L_49 = L_48->___next;
		V_3 = L_49;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t Dictionary_2_EnsureCapacity_mEC3380B4ABA6A8259247A732663459CD125A60FD_gshared (Dictionary_2_t9ED881003B3B6D4293A07C01CFE862F953347FF6* __this, int32_t ___0_capacity, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL_000b:
	{
		EntryU5BU5D_t9F4622A5BE7D4E910BC0E5EB4EF34C20E92AF5F7* L_1 = __this->____entries;
		if (!L_1)
		{
			goto IL_001d;
		}
...
IL_0025:
	...
	}
	{
		int32_t L_7 = ___0_capacity;
		int32_t L_8;
		L_8 = Dictionary_2_Initialize_m222A4E18F1E25560E3BE8B93E14AA7E3E79E1D03(__this, L_7, il2cpp_rgctx_method(method->klass->rgctx_data, 2));
		return L_8;
	}
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_mA58FF1BB0702CB7CBCA3CC611DF4C2494A93A5E1(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 54));
		int32_t L_12 = V_1;
		return L_12;
	}
}
...
IL_0009:
	...
	try
	{
		...
		try
		{
			Il2CppChar L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m2D504B5417D29DF6E694D02771C98DE32FB9D5FF(__this, L_3, ((*(int32_t*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 59));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
IL_0009:
	...
	try
	{
		...
		try
		{
			Guid_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m87585F5A842A0867532FDDE762235689DFCBE37A(__this, L_3, ((*(XRReferenceImage_tB2544D6E18E55CD44F4EED1B0573A6A7154C1E2F*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 59));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
